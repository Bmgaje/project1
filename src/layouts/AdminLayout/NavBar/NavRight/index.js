...
const NavRight = () => {
  ...
  function allUser() {
    axios.get(Urls.get.currentUserRole).then((res) => {
      setUserName(res?.data?.user?.name || 'NA');
      setUserRole(res?.data?.user?.role || 'NA');
    });
  }
          ...
          <Dropdown align="start" className="drp-user">
            ...
            <Dropdown.Menu align="end" className="profile-notification">
              <div className="pro-head">
                ...
                <span>
                  <b>{userName}</b>, <i style={{ fontSize: '12px', color: '#69dbe6' }}>({userRole})</i>
                </span>
                <Link to="#" onClick={handleLogoutClick} className="dud-logout" title="Logout">
              ...
              <ListGroup as="ul" bsPrefix=" " variant="flush" className="pro-body">
                ...
                <ListGroup.Item as="li" bsPrefix=" ">
                  <Link to="#" onClick={handleLogoutClick} className="dropdown-item">
